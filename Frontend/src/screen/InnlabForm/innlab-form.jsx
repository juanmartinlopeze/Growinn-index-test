...
export function InnlabForm() {
	...
	const questions = [
		...
		},
		{
			...
			placeholder: 'Digite aquí',
			icon: <Tooltip triggerText={<img src='/info-circle.png' alt='Jerarquía 1' />} popupText='La Jerarquía 1 (Ejecución): realiza tareas operativas esenciales.' />,
			field: 'jerarquia1',
		},
		{
			id: 3,
		...
		},
		{
			...
			placeholder: 'Digite aquí',
			icon: <Tooltip triggerText={<img src='/info-circle.png' alt='Jerarquía 3' />} popupText='La Jerarquía 3 (Gerencial): implementa estrategias y toma decisiones a mediano plazo.' />,
			field: 'jerarquia3',
		},
		{
			id: 5,
			...
			placeholder: 'Digite aquí',
			icon: (
				<Tooltip triggerText={<img src='/info-circle.png' alt='Jerarquía 4' />} popupText='La Jerarquía 4 (Directivo): define la estrategia general, establece objetivos y asigna recursos.' />
			),
			field: 'jerarquia4',
		},
		{
	...
	const handleSubmit = () => {
		...
		const sumaJerarquias = Number(formData.jerarquia1) + Number(formData.jerarquia2) + Number(formData.jerarquia3) + Number(formData.jerarquia4)
