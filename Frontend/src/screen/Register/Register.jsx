...
export function Register() {
  ...
  async function onResendVerifyEmail(e) {
    ...
    setResending(false);
    setMsg(
      error ? mapSupabaseError(error) : "Correo de verificación reenviado."
    );
  }
  ...
  return (
    <section className="register-container">
      ...
      <div className="left-register-container">
        ...
        <p>
          Únete a las empresas que ya están transformando sus negocios con
          inteligencia artificial de manera estratégica y medible.
        </p>
        <ul>
        ...
        {status === "verify" ? (
          <div className="right-register-success">
            ...
            <p className="right-register-sub">
              Te enviamos un enlace a <strong>{lastEmail}</strong>. Abre tu
              bandeja y confirma para continuar.
            </p>
