...
import RegisterCard from '../../components/Cards/Card-register'
...
export function Register() {
	...
	const mailInboxIcon = (
		<svg width='54' height='54' viewBox='0 0 24 24' fill='none' xmlns='http://www.w3.org/2000/svg'>
			...
			/>
			<path d='M7 9L10.13 11.5C11.16 12.32 12.85 12.32 13.88 11.5L15.06 10.56' stroke='#090011' strokeWidth='1.5' strokeMiterlimit='10' strokeLinecap='round' strokeLinejoin='round' />
			<path
			...
			<div className='right-register-container'>
				{status === 'verify' ? (
					<div className='right-register-success'>
						...
						<a className='w-auto px-lg py-md text-neutral-50 rounded-xs bg-primary-n500 hover:bg-primary-600 transition-all duration-200' href='/login'>
							Iniciar sesión
						</a>
					...
					<>
						...
						<RegisterCard loading={loading} status={status} msg={msg} onSubmit={onSubmit} />
						<p className='right-register-footer mt-3'>
