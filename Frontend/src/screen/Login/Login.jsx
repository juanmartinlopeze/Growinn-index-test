...
export default function Login() {
  const InnlabLogo = (
    ...
    >
      <path
        fill="#fff"
        d="M55.979 6.132c.695.492 1.39.98 2.044 1.471l-5.683 7.85a24 24 0 0 0-2.044-1.471z"
      />
      <path
        fill="#fff"
      ...
      <path
        fill="#fff"
        d="M62.19 35.94c0 .53 0 1.103-.042 1.638h9.69v-3.27h-9.69c0 .53.043 1.103.043 1.637zM10.22 30.462a25 25 0 0 1 1.675-5.195l-9.24-2.986a32 32 0 0 0-1.676 5.195z"
      />
      <path
        fill="#fff"
        d="M10.22 30.462a25 25 0 0 1 1.675-5.195l-9.24-2.986a32 32 0 0 0-1.676 5.195zM56.305 19.423c.572.738 1.145 1.472 1.637 2.29l7.85-5.683a47 47 0 0 0-1.638-2.29z"
      />
      <path
        fill="#fff"
      ...
      <path
        fill="#fff"
        d="M53.035 55.813a33 33 0 0 1-3.066 2.29l5.725 7.85a33 33 0 0 0 3.066-2.29zM11.82 46.369a26.5 26.5 0 0 1-1.515-4.703l-9.24 2.985c.407 1.595.899 3.19 1.513 4.703z"
      />
      <path
        fill="#fff"
      ...
      <path
        fill="#fff"
        d="M61.377 42.404a29 29 0 0 1-1.065 3.27l9.241 2.985a32 32 0 0 0 1.065-3.27l-9.199-2.985zM58.183 49.846a30 30 0 0 1-2.124 2.944l7.85 5.682a30 30 0 0 0 2.124-2.943z"
      />
      <path
        fill="#fff"
  ...
  async function onForgotPassword(e) {
    e.preventDefault();
    if (!email) {
      setMsg("Escribe tu correo para enviarte el enlace de restablecimiento.");
      return;
    }
    setMsg(null);
    setMsgKind(null);
  ...
  return (
    <div className="login-container">
      ...
      <div className="left-login-container">
        {InnlabLogo}
        <h1>
          Evalúa e impulsa la <span>cultura de innovación</span> en tu empresa
        </h1>
        <p>
          Con nuestra plataforma avanzada de evaluación para medir y acelerar la
          adopción de inteligencia artificial en entornos empresariales.
        </p>
      ...
      <div className="right-login-container">
        <div className="right-login-header">
          <h2 className="right-login-title">
            Bienvenido a <span>iNNDEX</span>
          </h2>
          <p>Inicia sesión para tener acceso a nuestra plataforma</p>
        </div>
          ...
          <div className="login-cta">
                ...
                style={{
                  ...
                  border:
                    msgKind === "error"
                      ? "1px solid #FCA5A5"
                      : "1px solid #6EE7B7",
                  background: msgKind === "error" ? "#FEF2F2" : "#ECFDF5",
                  color: msgKind === "error" ? "#991B1B" : "#065F46",
                  fontSize: 14,
                }}
              >
                {msg}
            ...
            <div className="remember-forgot">
              ...
              <a
                ...
                style={{ fontSize: 14, color: "#F36A12" }}
              >
        ...
        <p className="right-login-footer" style={{ marginTop: 12 }}>
