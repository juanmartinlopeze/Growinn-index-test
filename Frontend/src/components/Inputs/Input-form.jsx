...
export function InputForm({ icon = false, label, placeholder, type = 'text', name, value, onChange, required = false }) {
	...
	const eyeOpened = (
		<svg xmlns='http://www.w3.org/2000/svg' width='20' height='14' fill='none' viewBox='0 0 20 14'>
			<path stroke='#999' strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M8 7a2 2 0 1 0 4 0 2 2 0 0 0-4 0' />
			<path stroke='#999' strokeLinecap='round' strokeLinejoin='round' strokeWidth='2' d='M19 7q-3.6 6-9 6T1 7q3.6-6 9-6t9 6' />
		</svg>
	)
